            ...
            <div class="card-deck">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Danos información sobre ti para que podamos generar tu tarjeta, en 3 pasos</p>
                    </div>
                    <div class="card-footer">
                        <a class="btn btn-block btn-info btn-lg" href="./paso_1.php">Empezar</a>
                    </div>
                </div>
            </div>
            <?php else: ?>
