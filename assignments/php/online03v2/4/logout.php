        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container inter-200">
                    <div class="mb-2">
                        <h1 class="display-3 mt-4 inter-700">Has cerrado sesión</h1>
                        <p class="lead">¡Hasta otra! Si quieres seguir introduciendo datos, siempre puedes 
                        volver a <a class="fg-dark1 font-weight-bold" href="./index.php" title="volver a inicio"> iniciar sesión</a></p>
                    </div>
                </div>
            </div>
