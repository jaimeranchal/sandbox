...
?>
    <body>
        ...
        // regex validar nombre
        $patronNombre = "/^[a-zñª\s.á-ú]+$/i";
        // funciones de validación
        require("./validacion.php");
        // nombre
        $_SESSION['nombre'] = validarCadena($patronNombre, $_POST['nombre']);
        // apellidos
        $_SESSION['apellidos'] = validarCadena($patronNombre, $_POST['apellidos']);
        // profesion
        $_SESSION['profesion'] = validarCadena($patronNombre, $_POST['profesion']);
        // url foto
        $_SESSION['foto'] = filter_var($_POST['foto'], FILTER_SANITIZE_URL);
        ...
        ?>
            <div class="mb-3">
                <h2 class="display-4">Paso 2</h2>
                <p class="lead">Datos de contacto</p>
            </div>
            <form action="./paso_3.php" method="POST">
                <div class="form-group">
                    <label for="tfno">tfno</label>
                    <input type="text" name="tfno" value="" id="tfno">
                </div>
                <div class="form-group">
