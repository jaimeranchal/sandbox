...
<html lang="es" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>PHP3: Autenticación básica</title>
...
?>
    <body class="d-flex flex-column min-vh-100">
         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <span class="navbar-text">
                    ...
                    <span class="fas fa-key"></span> <?=$muestraPass?>
                </span>
            </div>
        </nav>     
        ...
        <div class="jumbotron text-center">
                    <img src="../src/icons/auth-open.svg" alt="website in a circle" width="100px;"/>
            <h2 class="display-3">Autenticación HTTP</h2>
            <p class="lead">Formas de autenticarse en PHP (1)</p> 
        </div>
